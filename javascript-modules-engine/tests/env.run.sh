#!/bin/bash
# This is a copy of https://github.com/Jahia/jahia-cypress/blob/main/env.run.sh.
# The only difference is an extra step right after the usual provisioning (with env.provisioning.sh) to install the prepackaged site AFTER the artifacts are installed.
# See env.post-provision.sh added between OVERWRITE-BEGIN and OVERWRITE-END
...
# OVERWRITE-BEGIN
bash $BASEDIR/env.post-provision.sh
# OVERWRITE-END
