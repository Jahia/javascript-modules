#!/bin/bash
# This is a copy of https://github.com/Jahia/jahia-cypress/blob/main/env.provision.sh
# with an extra step to install the prepackaged site AFTER the artifacts are installed.
# See custom code between OVERWRITE-BEGIN and OVERWRITE-END comments
