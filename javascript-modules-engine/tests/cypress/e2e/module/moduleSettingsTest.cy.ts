...
describe("Check that Javascript module settings (UI extensions, rules, configs) are correctly deployed", () => {
  ...
  it("Ensure Content editor UI extension is correctly registered", function () {
    ...
    jcontent
      .getModule("/sites/javascriptTestSite/home/testModuleSettings/pagecontent")
      .get()
      .scrollIntoView();
    jcontent
      .getModule(
        "/sites/javascriptTestSite/home/testModuleSettings/pagecontent/testContentEditorExtension",
      )
      .doubleClick();
    getComponentBySelector(
      Collapsible,
