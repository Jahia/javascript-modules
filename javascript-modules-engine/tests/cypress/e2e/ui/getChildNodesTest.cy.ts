...
describe('getChildNodes function test', () => {
    ...
    it('Verify all children returned', function () {
        ...
        cy.get('div[data-testid="getChildNodes_all_1"]').contains(
            '/sites/npmTestSite/home/testGetChildNodes/pagecontent/getChildNodesTest/child1',
        )
        cy.get('div[data-testid="getChildNodes_all_2"]').contains(
            '/sites/npmTestSite/home/testGetChildNodes/pagecontent/getChildNodesTest/child2',
        )
        cy.get('div[data-testid="getChildNodes_all_3"]').contains(
            '/sites/npmTestSite/home/testGetChildNodes/pagecontent/getChildNodesTest/filtered',
        )
        cy.get('div[data-testid="getChildNodes_all_4"]').contains(
            '/sites/npmTestSite/home/testGetChildNodes/pagecontent/getChildNodesTest/filtered2',
        )
        cy.get('div[data-testid="getChildNodes_all_5"]').contains(
            '/sites/npmTestSite/home/testGetChildNodes/pagecontent/getChildNodesTest/filtered3',
        )
