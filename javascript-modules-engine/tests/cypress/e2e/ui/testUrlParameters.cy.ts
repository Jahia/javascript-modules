...
describe("Test url parameters", () => {
  ...
  it("should display the url parameters", () => {
    cy.login();
    cy.visit(
      "/cms/render/default/en/sites/javascriptTestSite/home/testUrlParameters.html?test=root",
    );
  ...
  it("should display the url parameters with special chars", () => {
    ...
    cy.visit(
      "/cms/render/default/en/sites/javascriptTestSite/home/testUrlParameters.html?test=" + param,
    );
