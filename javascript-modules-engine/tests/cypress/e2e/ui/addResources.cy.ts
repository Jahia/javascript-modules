...
describe('Test on add resources component/helper', () => {
    ...
    it(`${pageName} : should contain a link tag in the head tag to load the CSS styles`, () => {
        ...
        cy.get('head link[href="/modules/jahia-npm-module-example/css/styles.css"]').then(
    ...
    it(`${pageName} : should contain a script tag under the body tag`, () => {
        cy.login()
        cy.visit(`/cms/render/default/en/sites/npmTestSite/home/${pageName}.html`)
        cy.get('body script[src="/modules/jahia-npm-module-example/javascript/body-script.js"]')
            .should('exist')
    ...
    it(`${pageName} : should contain a script tag under the head tag`, () => {
        cy.login()
        cy.visit(`/cms/render/default/en/sites/npmTestSite/home/${pageName}.html`)
        cy.get(`head script[src="${'/modules/jahia-npm-module-example/javascript/head-script.js'}"]`)
            .should('exist')
            .then(($script: JQuery<HTMLScriptElement>) => {
