  ...
  ({ "jcr:title": title, subtitle, authors, cover }: Props, { currentNode }) => {
    return (
      <article className={classes.card}>
        <Image node={cover} alt={title} width={320} />
        <h3>
