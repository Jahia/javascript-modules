...
/**
 * `jahiaComponent` functions are executed synchronously during module initialization. During this
 * time, `bundleKey` is set to the symbolic name of the active bundle.
 *
 * It can be retrieved during the execution of a view through `useServerContext`.
 */
