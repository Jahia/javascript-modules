 ...
 */
// Generic declaration
export function HydrateInBrowser<T>(props: Readonly<{
    /** The React component. */
...
export function HydrateInBrowser(props: Readonly<{
    /** The React component. */
    child: React.ComponentType,
}>): React.JSX.Element;

// Implementation
export function HydrateInBrowser<T>({child: Child, props}: Readonly<{
    child: React.ComponentType<T>,
    props?: T & React.JSX.IntrinsicAttributes
}>): React.JSX.Element {
    return (
        <InBrowser preRender child={Child} props={props as never} dataKey="data-reacthydrate"/>
    );
}
