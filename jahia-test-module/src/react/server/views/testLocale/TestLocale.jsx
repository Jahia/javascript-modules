...
export const TestLocale = () => {
  ...
  return (
    <>
      ...
      <div data-testid="currentResource_locale" test-shouldbeEn="true">
        {currentResourceLocale.toString()}
      </div>
      <h3>Current resource locale language</h3>
      <div data-testid="currentResource_localeLanguage" test-shouldbeEn="true">
        {currentResourceLocaleLanguage}
      </div>
      <h3>UI locale</h3>
      <div data-testid="renderContext_UILocale" test-shouldbeEn="true">
        {UILocale.toString()}
      </div>
      <h3>UI locale language</h3>
      <div data-testid="renderContext_UILocaleLanguage" test-shouldbeEn="true">
        {UILocaleLanguage}
      </div>
      <h3>Request locale</h3>
      <div data-testid="renderContext_requestLocale" test-shouldbeEn="true">
        {requestLocale.toString()}
      </div>
      <h3>Main resource locale</h3>
      <div data-testid="renderContext_mainResourceLocale" test-shouldbeEn="true">
        {mainResourceLocale.toString()}
      </div>
