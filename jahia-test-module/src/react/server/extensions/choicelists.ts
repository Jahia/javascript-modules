...
/**
 * Test fixture for JS-declared choicelist initializers, referenced from settings/definitions.cnd as
 * choicelist[testColorsInitializer].
 *
 * Exercises: localized labels, properties (defaultProperty), the CND parameter
 * (choicelist[testColorsInitializer='warm']), previous values passthrough, and the raw Java escape
 * hatch (property definition name).
 */
registerChoiceListInitializer(
