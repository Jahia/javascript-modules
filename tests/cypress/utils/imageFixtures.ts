/**
 * The image fixtures both image suites upload, and the intrinsic dimensions Jahia stores for each
 * as `j:width` / `j:height`. The srcset logic branches on where a width falls relative to
